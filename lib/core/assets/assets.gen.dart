...
class $AssetsImagesGen {
  ...
  AssetGenImage get logo => const AssetGenImage('assets/images/logo_yofagroup.png');
...
class $AssetsIconsMenuGen {
  ...
  SvgGenImage get kunjungan => const SvgGenImage('assets/icons/menu/kunjungan.svg');
  SvgGenImage get cuti => const SvgGenImage('assets/icons/menu/cuti.svg');

  SvgGenImage get callplan => const SvgGenImage('assets/icons/menu/callplan.svg');

  SvgGenImage get scanAlat => const SvgGenImage('assets/icons/menu/barcodealat.svg');
